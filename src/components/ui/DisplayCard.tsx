...
const DisplayCard = ({ title, text, linkHref, backgroundImageSrc }: DisplayCardProps) => {
    return (
        <Link href={linkHref} className="mx-auto md:mx-0">
            <div className={`card w-80 h-32 bg-base-200 shadow-md hover:shadow-xl hover:scale-105 transition-transform ${backgroundImageSrc && "image-full"}`}>
                ...
                <div className="card-body break-words w-80">
