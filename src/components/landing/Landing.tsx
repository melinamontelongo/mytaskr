...
const Landing = () => {
    return (<>
            <div className="pt-24 pb-10 flex flex-col px-5 gap-10 min-h-screen">
                <div className="flex md:flex-row flex-col items-center justify-center sm:justify-around px-5 gap-5">
                    <div className="space-y-5">
                        ...
                        <Link className="btn btn-primary normal-case rounded w-full md:w-auto" href="/sign-up">Register now!</Link>
                    </div>
                    <div>
                ...
                <div className="flex md:flex-row flex-col items-center justify-center sm:justify-around px-5 gap-5">
                    ...
                    <div className="space-y-5">
                        ...
                        <Link className="btn btn-primary normal-case rounded w-full md:w-auto" href="/sign-up">Go!</Link>
                    </div>
                </div>
            </div>
            <Footer />
